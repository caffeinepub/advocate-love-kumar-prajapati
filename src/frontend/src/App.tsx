  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundImage:
            "url('/assets/generated/hero-legal-bg.dim_1920x1080.jpg')",
        }}
      />
      <div
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-12 mt-8 items-center">
              <div>
                <div
                  className="aspect-square max-w-xs mx-auto rounded-none border-2 flex items-center justify-center"
                  style={{
                    borderColor: "oklch(0.73 0.12 85 / 0.4)",
                ...
                >
                  <img
                    src="/assets/generated/scales-justice-icon-transparent.dim_200x200.png"
        ...
        <div className="grid sm:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["home", "about", "practice", "appointment", "contact"].map(
                (id) => (
                  <li key={id}>
                    <button
                      type="button"
